...
const config = {
    // Bot Identity - CHOCO
    botName: process.env.BOT_NAME || 'CHOCO-ITACHI-V2',
    botOwner: process.env.BOT_OWNER || 'CHOCO ITACHI',
    ownerNumber: process.env.OWNER_NUMBER || '224000000000',
    author: process.env.AUTHOR || 'CHOCO-ITACHI',
    packname: process.env.PACKNAME || 'CHOCO-ITACHI-V2 😈',
    description: process.env.DESCRIPTION || '🍫 CHOCO-ITACHI-V2 - Le bot WhatsApp le plus violent 😈',
    version: '2.0.0',
    ...
    updateZipUrl: process.env.UPDATE_URL || 'https://github.com/CHOCO-ITACHI/CHOCO-ITACHI-V2/archive/refs/heads/main.zip',
    ytChannel: process.env.YT_CHANNEL || 'CHOCO ITACHI',
